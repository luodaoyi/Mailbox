  ...
  <div class="h-screen flex flex-col">
    <div class="bg-white border-b px-6 py-4 flex justify-between items-center">
      ...
      <div class="flex gap-2">
        <button @click="refreshEmails" :disabled="refreshing" class="px-3 py-2 text-sm bg-gray-500 text-white rounded hover:bg-gray-600 disabled:opacity-50 flex items-center gap-2">
